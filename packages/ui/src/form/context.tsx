...
// biome-ignore format: Helper type
export type FieldApi<TData> = SolidFieldApi<
  any, string, TData, any, any, any, any, any, any, any, any,
...
export function useFieldExtra<TData>(field?: Accessor<FieldApi<TData>>) {
  ...
  return createMemo(() => {
    ...
    return {
      ...
      validationState:
        errors.length > 0 ? ("invalid" as const) : ("valid" as const),
    };
  });
}
